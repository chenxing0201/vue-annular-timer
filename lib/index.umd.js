...
const _withScopeId = n => ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.pushScopeId)("data-v-a6038010"), n = n(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.popScopeId)(), n);
const _hoisted_1 = {
...
/* harmony default export */ var annular_timervue_type_script_lang_ts = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
  name: "annular-timer",
  props: {
    defaultColor: {
      type: String,
  ...
  data() {
    return {
      ...
      currentTextSize: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(this.defaultColor),
